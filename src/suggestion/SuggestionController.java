...
public class SuggestionController implements Initializable {
    ...
    private void getAddView() {
         ...
         try {
            Parent parent = FXMLLoader.load(getClass().getResource("/suggestion/addSuggestion.fxml"));
            ...
            Logger.getLogger(SuggestionController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        editIcon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            loader.setLocation(getClass().getResource("/suggestion/addSuggestion.fxml"));
                            try {
                                loader.load();
                            } catch (IOException ex) {
                                Logger.getLogger(SuggestionController.class.getName()).log(Level.SEVERE, null, ex);
                            ...
                            AddSuggestionController addSuggestionController = loader.getController();
                            addSuggestionController.setUpdate(true);
                            addSuggestionController.setTextField(suggestion.getId(), suggestion.getTitle(), 
