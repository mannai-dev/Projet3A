...
public class AdminReclamationController implements Initializable {
 ...
 private void loadDate() {
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        editIcon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            loader.setLocation(getClass().getResource("/adminReclamation/adminAddReclamation.fxml"));
                            try {
                                loader.load();
                            ...
                            AdminAddReclamationController addReclamationController = loader.getController();
    ...
    private void suggestion(ActionEvent event) throws IOException, SQLException  {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/adminSuggestion/adminSuggestion.fxml"));
